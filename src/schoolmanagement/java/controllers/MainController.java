...
//        System.out.println(LoginController.getInstance().getUsername());
        ...
        try {
            ...
            Logger.getLogger(MainController.class.getName()).log(Level.CONFIG, "错误，无法加载fxml文件，错误信息", e);
            e.getStackTrace();
        }
//        1142
...
//        contentController.getChildren().add(homePane);
    ...
    public void handlePopup() {
        ...
        try {
            ...
            Logger.getLogger(MainController.class.getName()).log(Level.SEVERE, "无法加载fxml文件", e);
            System.out.println(e.getMessage());
            e.printStackTrace();
        }
